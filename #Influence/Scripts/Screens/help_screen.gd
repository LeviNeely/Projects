...
var text: Array[String] = [
	...
	"Normal: The next most common type, appears 19.2% of the time.",
	"Uncommon: A more uncommon type, appears 15.4% of the time.",
	"Rare: A rare type, appears 12.5% of the time.",
	"Legendary: The most rare type, appears 3% of the time.",
